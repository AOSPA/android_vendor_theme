...
package cm.theme.platform.internal;
...
import static cm.theme.internal.util.ThemeUtils.SYSTEM_THEME_PATH;
import static cm.theme.internal.util.ThemeUtils.THEME_BOOTANIMATION_PATH;
import static cm.theme.platform.Manifest.permission.ACCESS_THEME_MANAGER;
...
public class ThemeManagerService extends SystemService {
    ...
    private void registerAppsFailureReceiver() {
        ...
        filter.addAction(cm.theme.content.Intent.ACTION_APP_FAILURE);
